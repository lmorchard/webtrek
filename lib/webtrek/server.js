    ...
    return {
        ...
        onLoopTick: function (time, delta) {
            ...
            for (var id in this.clients) {
                this.clients[id].handleMessages();
            }
            ...
            if ( (time-this.last_update_tick) > this.options.update_period ) {
                ...
                for (var id in entities) {
                    ...
                    if (!entity) { continue; }
                    var r = entity.produceRemoteUpdate();
                    update.push(r);
                }
                this.broadcast(OPS.ENTITY_UPDATE, [ time, update ]);
        ...
        setWorld: function (world) {
            ...
            var subs = {
                ...
                'updateEntity': function (entity) {
                    $this.broadcast(OPS.ENTITY_UPDATE, [ this.world.loop.tick, 
        ...
        broadcast: function (op, params) {
            ...
            for (var id in this.clients) {
                this.clients[id].send(op,params);
            }
        },
